...
\input{scenarios/barns}
\input{scenarios/experience_machine}
\input{scenarios/frank_and_furt}
\input{scenarios/gettier}
\input{scenarios/incompleteness_theorem}
\input{scenarios/john-thermometer}
\input{scenarios/name-day}
\input{scenarios/planet_b297a}
\input{scenarios/teleportation}
\input{scenarios/violinist}
